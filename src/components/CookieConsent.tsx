        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-surface-400 leading-relaxed">
              ...
              <a href="/legal/privacy" className="text-brand-500 hover:text-brand-400 underline">
                Privacy Policy
              </a>{' · '}
              <a href="/legal/cookies" className="text-brand-500 hover:text-brand-400 underline">
                Cookie Policy
              </a>
            </p>
          </div>
