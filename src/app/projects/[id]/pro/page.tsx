...
import { PRO_TOOLS, proToolsByGroup } from '@/lib/pro-tools';
        ...
        {groups.map(({ group, tools }) => (
          <div key={group}>
            <div className="flex items-center gap-2 mb-3">
              <h2 className="text-[11px] font-semibold text-surface-500 uppercase tracking-[0.04em]">{group}</h2>
              <span className="text-[11px] text-surface-700">{tools.length}</span>
            </div>
