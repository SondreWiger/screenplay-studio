                            ...
                            {canEdit && (
                              <>
                                <button
                                  ...
                                  className="opacity-100 md:opacity-0 md:group-hover:opacity-100 p-1 rounded text-surface-500 hover:text-white hover:bg-surface-700 transition-opacity"
                                  title="Edit"
                                >
                                ...
                                <button
                                  ...
                                  className="opacity-100 md:opacity-0 md:group-hover:opacity-100 p-1 rounded text-surface-500 hover:text-red-400 hover:bg-red-500/10 transition-opacity"
                                  title="Delete"
                                >
