    ...
    <div className="min-h-screen relative" style={{ background: 'rgb(var(--surface-950))', color: '#fff' }}>
      ...
      <footer className="relative z-10 border-t border-white/5">
        <div className="max-w-screen-lg mx-auto px-6 py-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-5">
            <Link href="/" className="text-[11px] font-medium uppercase tracking-[0.04em] text-white/55 hover:text-white/50 transition-colors">
              Home
            </Link>
            <Link href="/dashboard" className="text-[11px] font-medium uppercase tracking-[0.04em] text-white/55 hover:text-white/50 transition-colors">
              Dashboard
            </Link>
          </div>
        </div>
