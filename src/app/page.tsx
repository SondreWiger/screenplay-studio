  ...
  return (
    <div className="min-h-screen bg-surface-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 -left-40 w-96 h-96 bg-brand-500/5 rounded-full blur-3xl" />
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-8 pt-20 pb-32">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-6xl md:text-7xl font-bold tracking-tight">
            <span className="text-white">Write. Collaborate.</span>
            <br />
            <span className="gradient-text">Produce.</span>
          </h1>

          <p className="mt-8 text-xl text-surface-400 max-w-2xl mx-auto leading-relaxed">
            The all-in-one screenplay writing and film production platform.
            Industry-standard formatting, real-time collaboration, scene breakdowns,
            shot lists, scheduling, and everything you need from first draft to final cut.
          </p>

          <div className="mt-12 flex items-center justify-center gap-4">
            <Link
              href="/auth/register"
              className="px-8 py-4 text-base font-semibold text-white bg-gradient-to-r from-brand-600 to-brand-500 hover:from-brand-500 hover:to-brand-400 rounded-xl transition-all shadow-xl shadow-brand-600/20 hover:shadow-brand-500/30"
            >
              Start Writing — Free
            </Link>
            <Link
              href="#features"
              className="px-8 py-4 text-base font-medium text-surface-300 border border-surface-700 hover:border-surface-500 hover:text-white rounded-xl transition-all"
            >
              Explore Features
            </Link>
          </div>
        ...
        <div className="mt-24 relative">
          ...
          <div className="max-w-4xl mx-auto rounded-2xl border border-surface-800 bg-surface-900/80 backdrop-blur-xl shadow-2xl overflow-hidden">
            {/* Window controls */}
            <div className="flex items-center gap-2 px-4 py-3 border-b border-surface-800">
              ...
              <div className="flex-1 text-center text-xs text-surface-500">THE_MIDNIGHT_HOUR.screenplay</div>
            </div>
            {/* Script content mock */}
            <div className="p-8 font-screenplay text-sm leading-relaxed bg-white/[0.02]">
              <p className="uppercase font-bold text-brand-400 mb-4">FADE IN:</p>
              ...
              <p className="uppercase text-center text-orange-400 mb-1 ml-32">DETECTIVE MARLOW</p>
              <p className="text-center text-surface-500 mb-0.5 ml-20">(into phone, urgent)</p>
