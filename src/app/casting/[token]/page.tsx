    ...
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <div className="border-b border-neutral-800 bg-neutral-900/50">
        <div className="max-w-2xl mx-auto px-4 py-6">
          <p className="text-xs text-amber-400 uppercase tracking-[0.04em] font-medium mb-1">Casting Call</p>
              ...
              {characters.map((char) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className={`text-[11px] px-1.5 py-0.5 rounded ${char.is_main ? 'bg-brand-500/20 text-brand-500' : 'bg-neutral-800 text-neutral-400'}`}>
