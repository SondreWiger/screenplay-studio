  ...
  return (
    <div>
      <div className="max-w-4xl">
        <div className="mb-10">
          <p className="text-xs font-medium text-red-400 uppercase tracking-[0.04em] mb-3">Data</p>
          <h1 className="text-3xl font-bold text-white tracking-tight">Data Processing Agreement</h1>
