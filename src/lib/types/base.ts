...
export type IdeaCategory = 'plot' | 'character' | 'dialogue' | 'visual' | 'sound' | 'location' | 'prop' | 'costume' | 'effect' | 'theme' | 'feature' | 'worldbuilding' | 'other';
...
export type ScriptType = 'screenplay' | 'stageplay' | 'episodic' | 'sketch' | 'comic' | 'podcast' | 'audio_drama' | 'youtube' | 'tiktok' | 'videogame';
export type ProjectType = 'film' | 'youtube' | 'tiktok' | 'podcast' | 'audio_drama' | 'documentary' | 'educational' | 'livestream' | 'tv_production' | 'stage_play' | 'videogame';
